...
@section('content')
    ...
    <div class="relative lg:mt-5 mt-[75px]  overflow-hidden  ">
        ...
        <div class="flex items-center justify-center bg-cover aspect-[16/4] bg-center duration-700 ease-in-out"
            data-carousel-item
            style="background-image: url('{{ asset('assets/images/gallery/' . $whyRepeatGymBanner->image) }}')">
            <!-- Dark Overlay -->
    ...
    <section class="mt-36 relative bg-cover duration-700 ease-in-out bg-blend-multiply overflow-hidden" data-aos="flip-left"
        ...
        style="
            ...
            background-image: url('{{ asset('assets/images/gallery/' . $whyRepeatGymCertifiedCoachRight->image) }}');
        ...
        <div class="relative max-w-screen-xl mx-auto flex flex-col md:flex-row items-center gap-10 px-4">
            <!-- Image Section -->
            <div class="flex-1">
                <img src="{{ asset('assets/images/gallery/' . $whyRepeatGymCertifiedCoachLeft->image) }}" alt="Certificate"
                    class="w-full h-auto" />
            </div>
            <!-- Text Section -->
