...
Route::group([
    ...
    Route::get('/whyrepeatgym', [HomeController::class, 'whyrepeatgym']);
    Route::get('/contact_us', [HomeController::class, 'contact']);
    Route::get('/service', [HomeController::class, 'service']);
    Route::get('/testimonial', [HomeController::class, 'testimonial']);
    Route::get('/tip', [HomeController::class, 'tip']);
    Route::get('/tips/{id}', [HomeController::class, 'show']);
    Route::get('/customer_joinded', [HomeController::class, 'customer_joinded']);
